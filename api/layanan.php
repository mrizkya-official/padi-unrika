                    ...
                    <div class="card card-layanan h-100 border-0 shadow-sm p-3">
                        <div class="card-body d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <a href="/pages/bebas-pustaka.php" target="_blank" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-external-link-alt"></i> Ajukan Bebas Pustaka</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-layanan h-100 border-0 shadow-sm p-3">
                        <div class="card-body d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <a href="/pages/cek-plagiarisme.php" target="_blank" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-external-link-alt"></i> Ajukan Cek Plagiat</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-layanan h-100 border-0 shadow-sm p-3">
                        <div class="card-body d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <a href="/pages/layanan-konsultasi.php" target="_blank" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-external-link-alt"></i> Mulai Konsultasi</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-layanan h-100 border-0 shadow-sm p-3">
                        <div class="card-body d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <a href="/pages/cek-kepuasan.php" target="_blank" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-external-link-alt"></i> Isi Survei</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-layanan h-100 border-0 shadow-sm p-3">
                        <div class="card-body d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <a href="/pages/cek-sumbangan-buku.php" target="_blank" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-external-link-alt"></i> Konfirmasi Sumbangan</a>
                            </div>
                        </div>
                    </div>
                </div>
